...
class TwoContainer extends Component {
  ...
  render () {
    return (
      <LayoutWithHeader pageTitle="Two">
        <Box flex flexDirection="column" justifyContent="space-between" marginBottom={5}>
          <Box>
            <ViewTitle fontSize={6} fontWeight="medium">Example Two Container</ViewTitle>
            <TwoSpecificComponent />
          </Box>
        </Box>
      </LayoutWithHeader>);
  }
...
TwoContainer.propTypes = {

};

export default connect(
  TwoContainer.mapStateToProps,
  TwoContainer.mapDispatchToProps,
)(TwoContainer);
